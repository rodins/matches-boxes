...
class AddEditDeleteRadioComponentFragmentTest {
    ...
    fun noItem_hintDisplayed() {
        ...
        val bundle = AddEditDeleteRadioComponentFragmentArgs.Builder(ADD_NEW_ITEM_ID, box).build().toBundle()
    ...
    fun argItem_nameEquals() {
        ...
        val bundle = AddEditDeleteRadioComponentFragmentArgs.Builder(component.id, box).build().toBundle()
        launchFragmentInContainer<AddEditDeleteRadioComponentFragment>(bundle, R.style.AppTheme)
    ...
    fun addItem_navigationCalled() {
        ...
        verify(navController).navigate(
            AddEditDeleteRadioComponentFragmentDirections
                .actionAddEditDeleteRadioComponentFragmentToRadioComponentsListFragment(box)
        )
    }
