...
class RadioComponentsListFragmentTest {
    ...
    fun noItems_noItemsTextDisplayed() {
        ...
        val bundle = RadioComponentsListFragmentArgs.Builder(boxId, setId, bag).build().toBundle()
    ...
    fun addItem_navigationCalled() {
        ...
        verify(navController).navigate(
            RadioComponentsListFragmentDirections
                .actionRadioComponentsListFragmentToAddEditDeleteRadioComponentFragment(boxId, ADD_NEW_ITEM_ID, setId, bag)
        )
    }
    ...
    fun selectItem_navigationCalled() {
        ...
        verify(navController).navigate(
            RadioComponentsListFragmentDirections
                .actionRadioComponentsListFragmentToAddEditDeleteRadioComponentFragment(boxId, component.id, setId, bag)
        )
    }
    ...
    fun boxEditClick_navigationCalled() {
        ...
        verify(navController).navigate(
            RadioComponentsListFragmentDirections
                .actionRadioComponentsListFragmentToAddEditDeleteMatchesBoxFragment(setId, boxId, bag)
        )
    }
