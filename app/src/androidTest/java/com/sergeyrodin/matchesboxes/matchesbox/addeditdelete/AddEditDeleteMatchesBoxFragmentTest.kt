...
class AddEditDeleteMatchesBoxFragmentTest{
    ...
    fun addItem_hintDisplayed() {
        ...
        val bundle = AddEditDeleteMatchesBoxFragmentArgs.Builder(set, null).build().toBundle()
    ...
    fun updateBox_navigationCalled() = runBlocking{
        ...
        verify(navController).navigate(
            AddEditDeleteMatchesBoxFragmentDirections
                .actionAddEditDeleteMatchesBoxFragmentToRadioComponentsListFragment(set, updatedBox)
        )
    }
